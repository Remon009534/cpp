...
{
    cout << "\nThe Password Of " << socialMed[0] << " >> " << pass[0] << endl;
}

void telegram(string pass[5], string socialMed[5])
{
    cout << "\nThe Password Of " << socialMed[1] << " >> " << pass[1] << endl;
}

void snapchat(string pass[5], string socialMed[5])
{
    cout <<"\nThe Password Of " << socialMed[2] << " >> " << pass[2] << endl;
}

void facebook(string pass[5], string socialMed[5])
{
    cout << "\nThe Password Of " << socialMed[3] << " >> " << pass[3] << endl;
}

void messenger(string pass[5], string socialMed[5])
{
    cout << "\nThe Password Of " << socialMed[4] << " >> " << pass[4] << endl;
}
